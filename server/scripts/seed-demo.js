...
const listings = [
  ...
  {
    title: "Template PowerPoint thuyết trình hiện đại",
    listingType: "digital_product",
    description: "Bộ template PowerPoint dành cho bài thuyết trình, seminar và báo cáo dự án. Có sẵn slide mở đầu, nội dung, biểu đồ và kết luận.",
    shortTitle: "Template PowerPoint",
    shortDesc: "Tải template PowerPoint chỉnh sẵn bố cục.",
    cat: "design", price: 69000, deliveryTime: 0, revisionNumber: 0,
    features: ["20 slide mẫu", "Màu dễ chỉnh", "Có slide biểu đồ"],
    digitalFileUrl: productFile, digitalFileName: "modern-powerpoint-template-demo.png",
    approvalStatus: "approved", cover: coverImages.powerpoint, sales: 38, totalStars: 45, starNumber: 9,
  },
  {
  ...
  {
    title: "Edit video quảng cáo sản phẩm 15 giây",
    listingType: "skill_service",
    description: "Cắt ghép video quảng cáo ngắn, thêm chữ, nhạc nền và CTA để đăng TikTok, Reels hoặc Shorts.",
    shortTitle: "Edit video quảng cáo",
    shortDesc: "Video ngắn gọn, bắt mắt, dễ đăng mạng xã hội.",
    cat: "video", price: 180000, deliveryTime: 2, revisionNumber: 2,
    features: ["Video 15-30 giây", "Text nổi bật", "Nhạc nền phù hợp"],
    approvalStatus: "approved", cover: coverImages.reels, sales: 31, totalStars: 50, starNumber: 10,
  },
  {
    title: "Template edit video Reels/TikTok",
    listingType: "digital_product",
    description: "Bộ template edit video giúp dựng nhanh Reels/TikTok với intro, caption, chuyển cảnh và hướng dẫn sử dụng.",
    shortTitle: "Template edit video",
    shortDesc: "Tải template edit video dùng ngay.",
    cat: "video", price: 79000, deliveryTime: 0, revisionNumber: 0,
    features: ["Intro mẫu", "Caption mẫu", "Hướng dẫn dùng"],
    digitalFileUrl: productFile, digitalFileName: "template-edit-video-demo.png",
    approvalStatus: "approved", cover: coverImages.reels, sales: 44, totalStars: 45, starNumber: 9,
  },
  {
  ...
  {
    title: "Làm website React cho shop nhỏ",
    listingType: "skill_service",
    description: "Xây dựng website React cho cửa hàng nhỏ, portfolio hoặc landing page bán dịch vụ. Giao diện rõ ràng, dễ sửa nội dung.",
    shortTitle: "Website React cho shop",
    shortDesc: "Website React đẹp, responsive, dễ quản lý.",
    cat: "web", price: 550000, deliveryTime: 5, revisionNumber: 2,
    features: ["React + Vite", "Responsive mobile", "Form liên hệ"],
    approvalStatus: "approved", cover: coverImages.landingPage, sales: 27, totalStars: 50, starNumber: 10,
  },
  {
  ...
  },
  {
    ...
    listingType: "digital_product",
    description: "Bộ template CV có thể chỉnh sửa cho sinh viên và người mới đi làm. Phù hợp tìm kiếm Template CV trên SkillHub.",
    shortTitle: "CV Canva cho sinh viên",
    shortDesc: "Bộ template CV tải về trực tuyến.",
    cat: "education", price: 49000, deliveryTime: 0, revisionNumber: 0,
    features: ["5 mẫu CV", "Dễ chỉnh sửa", "Phù hợp sinh viên"],
    digitalFileUrl: productFile, digitalFileName: "canva-cv-template-demo.png",
    approvalStatus: "approved", cover: coverImages.cv, sales: 36, totalStars: 25, starNumber: 5,
  },
  {
    title: "Template CV ATS tiếng Việt",
    listingType: "digital_product",
    description: "Mẫu CV ATS tiếng Việt gồm bố cục rõ ràng, phần kỹ năng, kinh nghiệm và học vấn. Tải về chỉnh sửa ngay sau thanh toán.",
    shortTitle: "Template CV ATS",
    shortDesc: "Mẫu CV sạch, dễ sửa, phù hợp sinh viên.",
    cat: "education", price: 59000, deliveryTime: 0, revisionNumber: 0,
    features: ["Word + PDF", "Bố cục ATS", "Hướng dẫn chỉnh sửa"],
    digitalFileUrl: productFile, digitalFileName: "template-cv-ats-demo.png",
    approvalStatus: "approved", cover: coverImages.cv, sales: 42, totalStars: 48, starNumber: 10,
  },
  {
